                      ...
                      return Card(
                        ...
                        child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                Text(
                                    '${order.attributes!.items?.map((item) => item.productName).join(', ')}'),
                                Text('${order.attributes!.totalPrice}'),
                              ],
                            ),
                            trailing: Column(
                              children: [
                                Text('${order.attributes!.statusOrder},'),
                                Text(
                                    '${dateTime(order.attributes!.createdAt ?? DateTime(0, 0, 0)).toString()}')
                              ],
                            )),
                      );
                    },
